...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-6 iframe-container">
      <iframe src="{{asset('/resultado/FINALISTAS.pdf')}}"></iframe>
    </div>

    <div class="col-md-6 iframe-container">
          <h4> Resultado da 2° Etapa:  </h4>

      <iframe src="{{asset('/resultado/RESULTADO2ªETAPA.pdf')}}"></iframe>
    </div>
  </div>
            ...
            @foreach ($recibo as $key => $recibos)
                <div class="card-wrapper main-card">
                    <a class="card cardItemjs" data-toggle="modal" data-target="#exampleModal{{ $recibos->id }}">
                        ...
                        <div class="card-info">
                            <span class="text-light position-absolute top-0 end-0">
                                Votos contabilizados: <big class="badge bg-warning"> <b>{{ $recibos->likes->count() }}</b>
                                </big> </span>
                    ...
                    @else
                      ...
                      Votar nesta Receita</button> --}}
                            ...
                            <div class="like-content">
                                <button class="btn-like like-review" data-toggle="modal"
                                    data-target="#likeModal_{{ $recibos->id }}">
                                    Votar nesta receita
                                </button>
                            </div>

                            <!-- Modal -->
                            <div class="modal fade" id="likeModal_{{ $recibos->id }}" tabindex="-1" role="dialog"
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModal{{ $recibos->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="main-modal">
                            ...
                            <div class="modal-left">
                                ...
                                <div class="modal-info-header">
                                    <div class="left-side">
                                        <h1 class="modalHeader-js"> {{ $recibos->Nome_Prato ?? 'Nome da receita' }} <span
                                                class="badge bg-warning custom-badge badge-lg">
                                                <i class="bi bi-exclamation-triangle me-1"><b> VOTOS: </b> <big>
                                                        {{ $recibos->likes->count() }} </i> </big> </span></h1>
       ...
       --}}
                                ...
                                <div class="info-bar">
                                    ...
                                    <div class="info-wrapper">
                                        <div class="info-icon">
                                            <svg fill="#ffb354" width="24px" height="24px" viewBox="0 0 32 32"
                                                version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffb354">
              ...
              <div class="info-icon">
                <svg width="24px" height="24px" viewBox="0 0 1024 1024" class="icon" xmlns="http://www.w3.org/2000/svg" fill="#ffb354" stroke="#ffb354"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill="#ffb354" d="M224 128v704h576V128H224zm-32-64h640a32 32 0 0132 32v768a32 32 0 01-32 32H192a32 32 0 01-32-32V96a32 32 0 0132-32z"></path><path fill="#ffb354" d="M64 832h896v64H64zm256-640h128v96H320z"></path><path fill="#ffb354" d="M384 832h256v-64a128 128 0 10-256 0v64zm128-256a192 192 0 01192 192v128H320V768a192 192 0 01192-192zM320 384h128v96H320zm256-192h128v96H576zm0 192h128v96H576z"></path></g></svg>
                                ...
                                <div class="desc-wrapper">
                                    <div class="modal-info-header">
                                        <h1>Descrição
                                            <svg fill="#ffb354" height="30px" width="30px" version="1.1"
                                                id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
                                                xml:space="preserve" stroke="#ffb354">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                    stroke-linejoin="round"></g>
                                                <g id="SVGRepo_iconCarrier">
                                                    ...
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M326.808,174.848h-14.518c-4.512,0-8.17,3.658-8.17,8.17c0,4.512,3.658,8.17,8.17,8.17h14.518 c4.512,0,8.17-3.658,8.17-8.17C334.979,178.506,331.321,174.848,326.808,174.848z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M279.61,174.848h-94.418c-4.512,0-8.17,3.658-8.17,8.17c0,4.512,3.658,8.17,8.17,8.17h94.418 c4.512,0,8.17-3.658,8.17-8.17C287.78,178.506,284.122,174.848,279.61,174.848z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M326.808,207.529h-14.518c-4.512,0-8.17,3.658-8.17,8.17s3.658,8.17,8.17,8.17h14.518c4.512,0,8.17-3.658,8.17-8.17 S331.321,207.529,326.808,207.529z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M279.61,207.529h-94.418c-4.512,0-8.17,3.658-8.17,8.17s3.658,8.17,8.17,8.17h94.418c4.512,0,8.17-3.658,8.17-8.17 S284.122,207.529,279.61,207.529z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M326.808,240.21h-14.518c-4.512,0-8.17,3.658-8.17,8.17s3.658,8.17,8.17,8.17h14.518c4.512,0,8.17-3.658,8.17-8.17 S331.321,240.21,326.808,240.21z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M279.61,240.21h-94.418c-4.512,0-8.17,3.658-8.17,8.17s3.658,8.17,8.17,8.17h94.418c4.512,0,8.17-3.658,8.17-8.17 S284.122,240.21,279.61,240.21z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M326.808,272.89h-14.518c-4.512,0-8.17,3.658-8.17,8.17s3.658,8.17,8.17,8.17h14.518c4.512,0,8.17-3.658,8.17-8.17 S331.321,272.89,326.808,272.89z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M279.61,272.89h-94.418c-4.512,0-8.17,3.658-8.17,8.17s3.658,8.17,8.17,8.17h94.418c4.512,0,8.17-3.658,8.17-8.17 S284.122,272.89,279.61,272.89z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M326.808,384.551h-14.518c-4.512,0-8.17,3.658-8.17,8.17c0,4.512,3.658,8.17,8.17,8.17h14.518 c4.512,0,8.17-3.658,8.17-8.17C334.979,388.209,331.321,384.551,326.808,384.551z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                    <g>
                                                        <g>
                                                            <path
                                                                d="M279.61,384.551h-94.418c-4.512,0-8.17,3.658-8.17,8.17c0,4.512,3.658,8.17,8.17,8.17h94.418 c4.512,0,8.17-3.658,8.17-8.17C287.78,388.209,284.122,384.551,279.61,384.551z">
                                                            </path>
                                                        </g>
                                                    </g>
                                                </g>
                                            ...
                                            <tbody>
                                                @foreach ($recibos->produto as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->Nome }}</td>
                                                        <td>
                                                            <center> {{ $quantidade = $item->pivot['Quantidade'] }}
                                                        </td>
                                                        <td>
                                                            <center> {{ $quantidade = $item->pivot['unidade'] }}
                                                        </td>
                ...
                <p> </p>
                            ...
                            <div class="modal-right">
                                <div class="app-main-right-header">
                                    <span>Forma de Preparo <svg fill="#ffb354" width="30px" height="30px"
                                            viewBox="0 0 15 15" id="restaurant-noodle" xmlns="http://www.w3.org/2000/svg"
                                            stroke="#ffb354">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        ...
                                        <div class="profile-info-wrapper">
                                            <div class="profile-img-wrapper">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg" fill="#ffb354" stroke="#ffb354">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
                                                        <path fill="none" stroke="#ffb354" stroke-width="2"
                                ...
                                <div class="card-wrapper">
                                    <div href="1" class="card">
                                        <div class="profile-info-wrapper">
                                            <div class="profile-img-wrapper">
                                                <svg fill="#ffb354" width="30px" height="30px"
